...
parser = argparse.ArgumentParser(description="CATDTI for DTI prediction")
...
def main():
    ...
    if cfg.DA.USE:
        cfg.RESULT.OUTPUT_DIR = cfg.RESULT.OUTPUT_DIR + '_' + args.data + '_' + 'DA_' + args.split + '_' + str(
            cfg.SOLVER.SEED)
    else:
        cfg.RESULT.OUTPUT_DIR = cfg.RESULT.OUTPUT_DIR + '_' + args.data + '_' + args.split + '_' + str(cfg.SOLVER.SEED)
